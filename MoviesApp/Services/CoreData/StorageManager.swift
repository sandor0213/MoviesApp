...
final class StorageManager {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        let container = NSPersistentContainer(name: Constants.PersistentContainer.persistentContainerName)
    ...
    func saveMoviesModel(moviesModel: MoviesModel) {
            let context = persistentContainer.viewContext
        
            let fetchRequest: NSFetchRequest<NSFetchRequestResult> = MoviesModelEntity.fetchRequest()
            let deleteRequest = NSBatchDeleteRequest(fetchRequest: fetchRequest)
            do {
                try context.execute(deleteRequest)
            } catch {
                print("Failed to delete existing MoviesModelEntities: \(error)")
            }
    ...
    func fetchMoviesModel() -> MoviesModel? {
            let context = persistentContainer.viewContext
            ...
            do {
                ...
                if let moviesModelEntity = moviesModelEntities.first {
